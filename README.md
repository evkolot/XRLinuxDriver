...
| TCL/RayNeo | NXTWEAR&nbsp;S/S+<br/>Air&nbsp;2<br/>2s<br/>3s/Pro | :heavy_check_mark: | :+1: | :heavy_check_mark: | :heavy_check_mark: |                                                       | Unofficial, open-source USB protocol implementation (no SDK).                                                                          |
